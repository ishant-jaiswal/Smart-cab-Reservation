...
Here are screenshots of the key screens in the SmartCab app:
...
For a complete list of dependencies and versions, refer to `SmartCabReservation/gradle/libs.versions.toml`.
...
For the ML service, refer to `SmartCabReservation/ml_service/requirements.txt`.
...
1. Navigate to the `ml_service` directory:
   ```
   cd SmartCabReservation/ml_service
   ```
...
#### SmartCabReservation/ml_service/app.py
```python
...
#### SmartCabReservation/ml_service/requirements.txt
```
flask
scikit-learn
numpy
